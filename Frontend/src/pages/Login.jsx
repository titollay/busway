...
export default function Login() {
    ...
    e.preventDefault();
    // Ajoute logique d'authentification ici !!
        ...
        >
          ...
          {/* Form */}
            ...
            <div>
                ...
                onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="w-full bg-[#070320] border border-blue-900/40 rounded-xl px-4 py-3 text-white text-sm
                placeholder:text-gray-600 focus:outline-none focus:border-blue-500/60 transition duration-300"/>
                <button
                    type="button"
            ...
            <div className="text-right">
                ...
                <a href="/forgot-password" className="text-xs text-blue-400">   Mot de passe oublié ?</a>
            </div>
